 ...
 * a non-parameter constructor of superclass.
 *
 * @author Lam Tong
 * @version 1.0.0
 * @since 1.0.0
...
public class ProxyForClassWithMultipleInterfaces {

    private static final Logger logger = Logger.getLogger(ProxyForClassWithMultipleInterfaces.class.getName());
