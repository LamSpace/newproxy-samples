...
/**
 * Demonstrate of generating dynamic proxy class for a class with non-parameter constructor. In this sample,
 * the class {@code UserController} is used as an example. The third and the forth parameter of
 * {@link NewProxy#newProxyInstance(ClassLoader, InvocationInterceptor, Class[], Object[], Class[]) newProxyInstance}
 * are {@code null}, which means the superclass {@link UserController} only has a non-parameter constructor.
 *
 * @author Lam Tong
 * @version 1.0.0
 * @since 1.0.0
...
public class ProxyForClassWithNonParameterConstructor {

    private static final Logger logger = Logger.getLogger(ProxyForClassWithNonParameterConstructor.class.getName());
    ...
    public static void main(String[] args) {
        ...
        UserController userController = (UserController) NewProxy.newProxyInstance(UserController.class.getClassLoader(),
                interceptor,
                null,
                null,
