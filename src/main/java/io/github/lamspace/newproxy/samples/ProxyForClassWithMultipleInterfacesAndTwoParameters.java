 ...
 * a parameterized constructor of superclass with two parameter.
 *
 * @author Lam Tong
 * @version 1.0.0
 * @since 1.0.0
...
public class ProxyForClassWithMultipleInterfacesAndTwoParameters {

    private static final Logger logger = Logger.getLogger(ProxyForClassWithMultipleInterfacesAndTwoParameters.class.getName());
